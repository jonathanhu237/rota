...
type userPositionRepository interface {
	ListPositionsByUserID(ctx context.Context, userID string) ([]*model.Position, error)
	ReplacePositionsByUserID(ctx context.Context, userID string, positionIDs []int64) error
}
...
func (s *UserPositionService) ListUserPositions(ctx context.Context, userID string) ([]*model.Position, error) {
