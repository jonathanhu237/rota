...
type shiftChangeRepository interface {
	...
	CountPendingForCounterpart(ctx context.Context, userID string, now time.Time) (int, error)
...
func (s *ShiftChangeService) CreateShiftChangeRequest(
	...
	if input.PublicationID <= 0 ||
		!validUserID(input.RequesterUserID) ||
...
func (s *ShiftChangeService) GetShiftChangeRequest(
	ctx context.Context,
	requestID int64, viewerUserID string,
	viewerIsAdmin bool,
) (*model.ShiftChangeRequest, error) {
	if requestID <= 0 {
		return nil, ErrInvalidInput
...
func (s *ShiftChangeService) ListShiftChangeRequests(
	ctx context.Context,
	publicationID int64, viewerUserID string,
	viewerIsAdmin bool,
) ([]*model.ShiftChangeRequest, error) {
	if publicationID <= 0 {
		return nil, ErrInvalidInput
...
func (s *ShiftChangeService) CancelShiftChangeRequest(
	...
	if requestID <= 0 || !validUserID(viewerUserID) {
...
func (s *ShiftChangeService) canViewRequest(req *model.ShiftChangeRequest, viewerUserID string, admin bool) bool {
	if admin {
		return true
	}
	if req.RequesterUserID == viewerUserID {
...
func (s *ShiftChangeService) mutuallyQualified(
	ctx context.Context,
	userA, userB string, positionA, positionB int64,
) error {
