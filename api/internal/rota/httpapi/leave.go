...
type leaveService interface {
	...
	Cancel(ctx context.Context, leaveID int64, userID string) error
	GetByID(ctx context.Context, leaveID int64, viewerUserID string, viewerIsAdmin bool) (*service.LeaveDetail, error)
	ListPool(ctx context.Context, viewerUserID string, viewerIsAdmin bool, input service.ListLeavePoolInput) (*service.LeavePoolResult, error)
	ListForUser(ctx context.Context, userID string, input service.ListLeavesInput) ([]*service.LeaveDetail, error)
	ListForPublication(ctx context.Context, publicationID int64, input service.ListLeavesInput) ([]*service.LeaveDetail, error)
	PreviewOccurrences(ctx context.Context, userID string, from time.Time, to time.Time) ([]*service.OccurrencePreview, error)
}
