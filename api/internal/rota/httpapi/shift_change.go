...
type shiftChangeService interface {
	...
	GetShiftChangeRequest(ctx context.Context, requestID int64, viewerUserID string, viewerIsAdmin bool) (*model.ShiftChangeRequest, error)
	ListShiftChangeRequests(ctx context.Context, publicationID int64, viewerUserID string, viewerIsAdmin bool) ([]*model.ShiftChangeRequest, error)
	CountPendingForViewer(ctx context.Context, viewerUserID string) (int, error)
	CancelShiftChangeRequest(ctx context.Context, requestID int64, viewerUserID string) error
	RejectShiftChangeRequest(ctx context.Context, requestID int64, viewerUserID string) error
	ApproveShiftChangeRequest(ctx context.Context, requestID int64, viewerUserID string) error
...
type createShiftChangeRequestBody struct {
	...
	CounterpartUserID         *string `json:"counterpart_user_id,omitempty"`
