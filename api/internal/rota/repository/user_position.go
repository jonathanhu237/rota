...
func (r *UserPositionRepository) ListPositionsByUserID(ctx context.Context, userID string) ([]*model.Position, error) {
...
func (r *UserPositionRepository) ReplacePositionsByUserID(ctx context.Context, userID string, positionIDs []int64) error {
...
func (r *UserPositionRepository) userExists(ctx context.Context, rower queryRower, userID string) (bool, error) {
	const query = `
		SELECT EXISTS (
			SELECT 1
			FROM users
