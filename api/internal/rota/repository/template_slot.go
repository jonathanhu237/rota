...
func mapTemplateSlotPositionWriteError(err error) error {
	...
	switch {
	case code == "23505" && constraint == templateSlotPositionsOneAttendanceResponsibleIndex:
		return ErrAttendanceResponsibleRequired
	case code == "23514" && constraint == templateSlotPositionsResponsibleHeadcountCheck:
		return ErrAttendanceResponsibleRequired
	default:
		return err
	}
