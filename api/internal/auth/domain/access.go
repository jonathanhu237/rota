...
func DefaultPermissionCatalog() PermissionCatalog {
	catalog, _ := NewPermissionCatalog(
		...
		PermissionDefinition{Key: PermissionRotaSelf, Resource: "rota", Action: "self", LabelKey: "permissions.rota.self", Description: "Use employee self-service, including submitting personal availability; no administrative grants."},
		PermissionDefinition{Key: PermissionRotaRead, Resource: "rota", Action: "read", LabelKey: "permissions.rota.read", Description: "View Rota scheduling data."},
		PermissionDefinition{Key: PermissionRotaManage, Resource: "rota", Action: "manage", LabelKey: "permissions.rota.manage", Description: "Manage Rota positions, templates, publications, assignments, and attendance."},
	)
...
const (
	...
	PermissionRotaSelf          PermissionKey = "rota.self"
	PermissionRotaRead          PermissionKey = "rota.read"
	PermissionRotaManage        PermissionKey = "rota.manage"
)
