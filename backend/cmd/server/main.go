...
func main() {
	...
	mux.HandleFunc("GET /publications/{id}/submissions/me", authHandler.RequireAuth(publicationHandler.ListMySubmissionSlotPositions))
	mux.HandleFunc("POST /publications/{id}/submissions", authHandler.RequireAuth(publicationHandler.CreateSubmission))
	mux.HandleFunc("DELETE /publications/{id}/submissions/{slot_id}/{position_id}", authHandler.RequireAuth(publicationHandler.DeleteSubmission))
