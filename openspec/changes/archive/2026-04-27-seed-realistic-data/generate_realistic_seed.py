...
def main() -> None:
    ...
    output_path = project_root / "backend/cmd/seed/scenarios/realistic.go"
...
def render_go(
    ...
    return f"""// Code generated by openspec/changes/seed-realistic-data/generate_realistic_seed.py; DO NOT EDIT.
...
\t\t\t\tnow,
\t\t\t).Scan(&slotID); err != nil {{
\t\t\t\treturn slotIDs, fmt.Errorf("insert realistic slot weekday=%d %s-%s: %w", weekday, slot.Start, slot.End, err)
\t\t\t}}
...
\t\t\t\t\tnow,
\t\t\t\t); err != nil {{
\t\t\t\t\treturn fmt.Errorf("insert realistic availability employee=%s slot=%d: %w", employee.Slug, slotID, err)
\t\t\t\t}}
\t\t\t\tinserted++
\t\t\t}}
\t\t}}
