...
import { DatePicker } from "@/features/rota/components/date-time-picker"
...
export const Route = createFileRoute("/_authenticated/rota/leaves/new")({
  component: LeavePage,
})
