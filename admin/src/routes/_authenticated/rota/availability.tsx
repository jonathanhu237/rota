...
import { AvailabilityGrid } from "@/features/rota/components/availability/availability-grid"
...
export const Route = createFileRoute("/_authenticated/rota/availability")({
