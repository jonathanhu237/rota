...
import { DeletePositionDialog } from "@/features/rota/components/positions/delete-position-dialog"
import {
  PositionFormDialog,
  type PositionFormValues,
} from "@/features/rota/components/positions/position-form-dialog"
import { PositionsTable } from "@/features/rota/components/positions/positions-table"
...
export const Route = createFileRoute("/_authenticated/rota/positions")({
    ...
    <>
      <Card>
        <CardHeader className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          {canManage ? <Button onClick={openCreateDialog}>
            <BriefcaseBusiness />
