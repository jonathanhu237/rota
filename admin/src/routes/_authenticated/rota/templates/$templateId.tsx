...
import { CloneTemplateDialog } from "@/features/rota/components/templates/clone-template-dialog"
import { DeleteTemplateEntryDialog } from "@/features/rota/components/templates/delete-template-entry-dialog"
import { DeleteTemplateDialog } from "@/features/rota/components/templates/delete-template-dialog"
import { sortTemplateSlots } from "@/features/rota/components/templates/group-template-slots"
import { TemplateSlotDialog } from "@/features/rota/components/templates/template-slot-dialog"
import { TemplateSlotPositionDialog } from "@/features/rota/components/templates/template-slot-position-dialog"
import {
  createTemplateSchema,
  type TemplateFormValues,
  type TemplateSlotFormValues,
  type TemplateSlotPositionFormValues,
} from "@/features/rota/components/templates/template-schemas"
...
import type { TemplateSlot, TemplateSlotPosition } from "@/features/rota/types"

export const Route = createFileRoute("/_authenticated/rota/templates/$templateId")({
          ...
          <CardHeader className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                disabled={!canManage || cloneTemplateMutation.isPending}
              >
              ...
              <Button
                ...
                disabled={!canManage || isLocked || deleteTemplateMutation.isPending}
              >
            ...
            >
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  disabled={!canManage || isLocked || updateTemplateMutation.isPending}
                  {...register("name")}
                />
                {errors.name && (
              ...
              <div className="flex justify-end">
                <Button
                  type="submit"
                  disabled={!canManage || isLocked || !isDirty || updateTemplateMutation.isPending}
                >
                    ...
                    {!isLocked && canManage && (
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          variant="destructive"
                          disabled={!canManage || deleteSlotMutation.isPending}
                            ...
                            {!isLocked && canManage && (
                              <div className="flex flex-wrap gap-2">
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  variant="destructive"
                                  disabled={!canManage || deleteSlotPositionMutation.isPending}
                                  onClick={() =>
