...
} from "@/features/rota/schedule-time"
import type { AttendanceRosterEntry, AttendanceShift } from "@/features/rota/types"
import { cn } from "@/features/rota/utils"
          ...
          <Card>
            ...
            <CardContent>
              ...
              >
                ...
                />
                <Button type="submit" disabled={!canManage || settingsMutation.isPending}>
            ...
            <CardContent className="grid gap-5">
              <div className="grid gap-2">
                {selectedShift.roster.map((row) => (
                  <AdminRosterRow
                    ...
                    pending={!canManage || arrivalMutation.isPending || clearArrivalMutation.isPending}
                    onChange={(value) =>
                  ...
                  {selectedShift.orphan_arrivals.map((record) => (
                    ...
                    >
                      ...
                      <Button
                        ...
                        variant="outline"
                        size="sm"
                        disabled={!canManage || clearArrivalMutation.isPending}
              ...
              <section className="grid gap-3 border-t pt-4">
                ...
                >
                  ...
                  />
                  <Button type="submit" disabled={!canManage || createOvertimeMutation.isPending}>
                ...
                {selectedShift.overtime_records.map((record) => (
                  ...
                  >
                    ...
                    <Input
                      ...
                      disabled={!canManage}
                    />
                    <Input name="note" defaultValue={record.note} disabled={!canManage} />
                    <Button type="submit" variant="outline" size="sm" disabled={!canManage || updateOvertimeMutation.isPending}>
                    ...
                    <Button
                      ...
                      variant="destructive"
                      size="sm"
                      disabled={!canManage || deleteOvertimeMutation.isPending}
...
function AdminRosterRow({
  ...
  return (
    <div className="grid gap-3 rounded-lg border p-3 sm:grid-cols-[1fr_220px_auto_auto] sm:items-center">
      ...
      <Input type="datetime-local" value={value} disabled={pending} onChange={(event) => onChange(event.target.value)} />
