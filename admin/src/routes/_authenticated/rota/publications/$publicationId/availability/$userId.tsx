...
import { AdminAvailabilityGrid } from "@/features/rota/components/availability/admin-availability-grid"
import { getSlotWeekdayKey } from "@/features/rota/components/availability/admin-availability-keys"
...
import type { AdminAvailabilityDetail, SlotRef } from "@/features/rota/types"
...
export function PublicationAvailabilityEditorPage() {
  ...
  const detailQuery = useQuery(
    adminAvailabilityDetailQueryOptions(numericPublicationID, targetUserID),
  )
