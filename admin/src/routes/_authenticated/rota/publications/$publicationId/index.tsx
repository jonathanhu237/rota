...
import { DeletePublicationDialog } from "@/features/rota/components/publications/delete-publication-dialog"
...
import { DateTimePicker } from "@/features/rota/components/date-time-picker"
...
import { getPublicationLifecycleAction } from "@/features/rota/publications"
import {
  activatePublication,
  deletePublication,
  endPublication,
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {(publication.state === "PUBLISHED" ||
                ...
                <Link
                  className={buttonVariants({ variant: "outline" })}
                  params={{ publicationId: String(publication.id) }}
                  to="/rota/publications/$publicationId/shift-changes"
                >
              ...
              {canManage && publication.state === "DRAFT" && (
                <Button
                  variant="destructive"
