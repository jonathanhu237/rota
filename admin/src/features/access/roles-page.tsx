...
const permissionLabelKeys: Record<string, string> = {
 ...
 'online-users.write': 'permissionOnlineUsersWrite',
  ...
  'rota.self': 'permissionRotaSelf',
  'rota.read': 'permissionRotaRead',
  'rota.manage': 'permissionRotaManage',
}
...
const permissionDescriptionKeys: Record<string, string> = {
 ...
 'online-users.write': 'permissionOnlineUsersWriteDescription',
  ...
  'rota.self': 'permissionRotaSelfDescription',
  'rota.read': 'permissionRotaReadDescription',
  'rota.manage': 'permissionRotaManageDescription',
}
...
function isWritePermission(key: string): boolean {
	return key.endsWith('.write') || key === 'rota.manage'
}
