...
export function AuthenticatedShell({ api, user: initialUser, children }: { api: ApiClient; user: User; children: React.ReactNode }) {
  const { t: typedT } = useTranslation(['common', 'auth', 'problems', 'access', 'operationLog', 'onlineUsers', 'emailTasks'])
  ...
  useEffect(() => {
    ...
    if (previousOwnerID && previousOwnerID !== user.id) {
      ...
      void clearProtectedRotaCache(queryClient)
    }
          ...
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                <SidebarMenuItem><SidebarMenuButton asChild isActive={location.pathname === '/rota'} tooltip={t('common:dashboard')}><Link to="/rota" aria-current={location.pathname === '/rota' ? 'page' : undefined}><CalendarDays aria-hidden="true" data-icon="inline-start" /><span>{t('common:dashboard')}</span></Link></SidebarMenuButton></SidebarMenuItem>
                <SidebarMenuItem><SidebarMenuButton asChild isActive={location.pathname.startsWith('/rota/availability')} tooltip={t('common:availability')}><Link to="/rota/availability" aria-current={location.pathname.startsWith('/rota/availability') ? 'page' : undefined}><CalendarCheck aria-hidden="true" data-icon="inline-start" /><span>{t('common:availability')}</span></Link></SidebarMenuButton></SidebarMenuItem>
                <SidebarMenuItem><SidebarMenuButton asChild isActive={location.pathname.startsWith('/rota/roster')} tooltip={t('common:roster')}><Link to="/rota/roster" aria-current={location.pathname.startsWith('/rota/roster') ? 'page' : undefined}><ClipboardList aria-hidden="true" data-icon="inline-start" /><span>{t('common:roster')}</span></Link></SidebarMenuButton></SidebarMenuItem>
                <SidebarMenuItem><SidebarMenuButton asChild isActive={location.pathname.startsWith('/rota/requests')} tooltip={t('common:requests')}><Link to="/rota/requests" aria-current={location.pathname.startsWith('/rota/requests') ? 'page' : undefined}><ClipboardCheck aria-hidden="true" data-icon="inline-start" /><span>{t('common:requests')}</span></Link></SidebarMenuButton></SidebarMenuItem>
                <SidebarMenuItem><SidebarMenuButton asChild isActive={location.pathname.startsWith('/rota/leaves')} tooltip={t('common:leaves')}><Link to="/rota/leaves" aria-current={location.pathname.startsWith('/rota/leaves') ? 'page' : undefined}><Users aria-hidden="true" data-icon="inline-start" /><span>{t('common:leaves')}</span></Link></SidebarMenuButton></SidebarMenuItem>
                <SidebarMenuItem><SidebarMenuButton asChild isActive={location.pathname.startsWith('/rota/attendance')} tooltip={t('common:attendance')}><Link to="/rota/attendance" aria-current={location.pathname.startsWith('/rota/attendance') ? 'page' : undefined}><ClipboardCheck aria-hidden="true" data-icon="inline-start" /><span>{t('common:attendance')}</span></Link></SidebarMenuButton></SidebarMenuItem>
                {hasAccessMenu ? (
                  <SidebarMenuItem>
