          ...
          <SidebarGroup>
            ...
            <SidebarGroupContent>
              <SidebarMenu>
                ...
                <SidebarMenuItem><SidebarMenuButton asChild isActive={location.pathname.startsWith('/rota/leaves')} tooltip={t('common:rotaNavigation.leaves')}><Link to="/rota/leaves" aria-current={location.pathname.startsWith('/rota/leaves') ? 'page' : undefined}><Users aria-hidden="true" data-icon="inline-start" /><span>{t('common:rotaNavigation.leaves')}</span></Link></SidebarMenuButton></SidebarMenuItem>
                <SidebarMenuItem><SidebarMenuButton asChild isActive={location.pathname.startsWith('/rota/attendance')} tooltip={t('common:rotaNavigation.attendance')}><Link to="/rota/attendance" aria-current={location.pathname.startsWith('/rota/attendance') ? 'page' : undefined}><ClipboardCheck aria-hidden="true" data-icon="inline-start" /><span>{t('common:rotaNavigation.attendance')}</span></Link></SidebarMenuButton></SidebarMenuItem>
                {hasAccessMenu ? (
                  <SidebarMenuItem>
