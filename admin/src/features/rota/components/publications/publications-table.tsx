...
import { DataTable } from "@/features/rota/components/data-table"
import { Button } from "@/components/ui/button"
import {
  getPublicationLifecycleAction,
  type PublicationLifecycleAction,
} from "@/features/rota/publications"
import type { Pagination, Publication } from "@/features/rota/types"
...
export function PublicationsTable({
  ...
  const columns = React.useMemo<ColumnDef<Publication>[]>(
    ...
    [canManage, formatter, onLifecycleAction, t],
  )
