...
import { currentPublicationQueryOptions } from "@/features/rota/queries"
import type { Publication, User } from "@/features/rota/types"
    ...
    return (
      <Card>
        ...
        <CardContent className="grid gap-4">
          ...
          {isAdmin && (
            <div>
              <Link to="/rota/publications" className={buttonVariants()}>
...
function PublicationCTA({
  ...
  switch (publication.state) {
      ...
      return (
        <div>
          {isAdmin ? (
            ...
            <Link to="/rota/availability" className={buttonVariants()}>
    ...
    case "ACTIVE":
      return (
        <div>
          <Link to="/rota/roster" className={buttonVariants()}>
