...
## Purpose
Define occurrence-specific arrival and overtime records, derived attendance
status, leader entry windows, administrator correction workflows, roster-stale
protection, permissions, and stable attendance API errors.
## Requirements
