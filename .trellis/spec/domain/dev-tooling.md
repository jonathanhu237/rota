...
## Purpose
Define the supported development and deployment tooling contracts: production
TLS modes, isolated PostgreSQL integration-test execution, and deterministic
