...
## Purpose
Define the single application-wide product and organization identity used by
the public branding API, authenticated frontend shell, settings UI, and
transactional email rendering, including validation and optimistic concurrency.
## Requirements
