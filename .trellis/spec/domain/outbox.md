...
## Purpose
Define durable transactional email delivery, including atomic producer
enqueueing, worker claiming and retry behavior, localized rendering,
configuration validation, logging, and branding context.
## Requirements
