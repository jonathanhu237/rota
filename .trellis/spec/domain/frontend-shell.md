...
## Purpose
Define the authenticated application shell and the shared frontend workflows
that present scheduling, leave, assignment, attendance, navigation, branding,
and responsive page behavior to employees and administrators.
## Requirements
